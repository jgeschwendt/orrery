...
One bank per working directory under `/Users/jlg/.orrery/memory`. Sessions read their bank back at
...
flowchart TB
    ...
    C --> BANK[("~/.orrery/memory/&lt;bank&gt;/<br/>&lt;type&gt;_&lt;slug&gt;.md · MEMORY.md ·<br/>_archive/ · _dream.json")]
    BANK --> HOOK
    UI --- BANK
...
| ------- | ---------------------------------------------------------------- | ------------------- |
| managed | `/Users/jlg/.orrery/memory/<bank>/` — this system                        | yes (`writable?/1`) |
